...
type PartialMessagesExtension struct {
	...
	Message              *PartialMessage   `protobuf:"bytes,3,opt,name=message" json:"message,omitempty"`
	Iwant                *PartialIWANT     `protobuf:"bytes,4,opt,name=iwant" json:"iwant,omitempty"`
	Idontwant            *PartialIDONTWANT `protobuf:"bytes,5,opt,name=idontwant" json:"idontwant,omitempty"`
	Ihave                *PartialIHAVE     `protobuf:"bytes,6,opt,name=ihave" json:"ihave,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type PartialIWANT struct {
	Metadata             []byte   `protobuf:"bytes,1,opt,name=metadata" json:"metadata,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
